...
urlpatterns = [
    ...
    path('total-materias-programa/', materias.TotalMateriasPorProgramaView.as_view()),
    path('distribucion-materias-dias/', materias.DistribucionMateriasPorDiasView.as_view()),
    #Login
